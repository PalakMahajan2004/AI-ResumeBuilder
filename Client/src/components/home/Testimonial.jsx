...
const Testimonials = () => {
  const cardsData = [
    ...
    },
    {
      ...
      name: "Avery Johnson",
      handle: "@averywrites",
      feedback: "The platform is incredibly user-friendly and intuitive.",
    },
    {
      image:
      ...
      name: "Jordan Lee",
      handle: "@jordantalks",
      feedback: "Customer support is amazing! They solved my issue within minutes.",
    },
    {
      image:
      ...
      name: "Samantha Green",
      handle: "@samgreen",
      feedback: "I saw results instantly. Highly recommended to everyone!",
    },
    {
      image:
      ...
      name: "Ethan Brown",
      handle: "@ethanb",
      feedback: "An absolute game-changer for my daily workflow.",
    },
    {
      image:
      ...
      name: "Olivia White",
      handle: "@oliviaw",
      feedback: "I love the modern design and smooth experience.",
    },
  ];
