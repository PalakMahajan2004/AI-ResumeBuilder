...
const Footer = () => {
  ...
  return (
    <>
      <footer className="relative bg-gradient-to-b from-green-50 via-white to-green-100 pt-16">
        {/* Decorative Wave */}
        <div className="absolute top-0 left-0 w-full overflow-hidden leading-[0] rotate-180">
          <svg className="relative block w-full h-16" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none" viewBox="0 0 1200 120">
            <path d="M0,0V46.29c47.09,22,103.33,29.07,158.93,23.49C242.78,65.18,311,42,380,36.77c67-5,135,5,200,20,64,15,128,35,192,30s128-45,192-55,128,5,192,18c64,14,128,20,192,8V0Z" className="fill-green-200/60"></path>
          </svg>
        </div>

        <div className="max-w-7xl mx-auto px-6 md:px-16 lg:px-24 xl:px-32 flex flex-wrap justify-between gap-10 md:gap-20 mt-10">
          {/* Logo & Info */}
          <div className="flex flex-col gap-6 max-w-xs">
            ...
            <p className="text-gray-700">
              Helping everyone create professional resumes and land their dream jobs with AI-powered assistance.
            </p>
            <div className="flex items-center gap-4">
              {socialLinks.map((social, idx) => (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="text-gray-600 hover:text-green-500 transition transform hover:scale-110"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
          ...
          <div className="flex flex-wrap gap-10 md:gap-20">
            {Object.entries(links).map(([section, items], idx) => (
              <div key={idx} className="flex flex-col gap-3">
                <p className="text-gray-800 font-semibold text-lg">{section}</p>
        ...
        <div className="mt-16 border-t border-green-200 pt-6 text-center text-gray-500 text-sm">
